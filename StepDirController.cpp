...
void StepDirController::setup()
{
  ...
  // TMC429 Setup
  for (size_t tmc429=0; tmc429<constants::TMC429_COUNT; ++tmc429)
  {
    tmc429s_[tmc429].setup(constants::cs_pins[tmc429],constants::clock_frequency_mhz);
    tmc429s_[tmc429].setStepDirOutput();
  }
